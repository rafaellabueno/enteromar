...
import MauricioModal from "./Modals/MauricioModal";
import TooltipPopover from "../../IndexSections/TooltipPopover.js";

class Mauricio extends React.Component {
    state = {
        iconTabs: 1,
        plainTabs: 1
    };
                                ...
                                <div className="card-profile-image" style={{marginLeft: "-50px"}}>
                                    <a href="#" onClick={e => e.preventDefault()}>
                                        <img
                                            ...
                                            src={require("../../../assets/img/equipe/mauricio.gif")}
                                        />
                                    </a>
                                </div>
                            </Col>
                            <Col className="order-lg-6" lg="6">
                                <div className="text-center mt-5">
                                    <h3>
                                        ...
                                        <div className="card-profile-actions mt-lg-0" style={{marginTop: "200px"}}>
                                            <Button
                                                ...
                                                href="http://lattes.cnpq.br/3509599726683989"
                                                target="_blank"
                                            >
                                            ...
                                            <Button
                                                className="nav-link-icon"
                                                href="https://www.researchgate.net/profile/Mauricio_Tavares3"
                                                color="default"
                                                target="_blank"
                                            >
                                                <div className="icon icon-shape-2 icon-sm  rounded-circle text-white">
                                    ...
                                    <div className="h6 mt-4">
                                        ...
                                        Graduado em Bacharelado e Licenciatura em Ciências Biológicas pela Universidade Federal do Rio Grande do Sul (UFRGS)
                                    </div>
                                    <div>
