...
class AlineModal extends React.Component {
    state = {};
    toggleModal = state => {
        this.setState({
                ...
                >
                    ...
                    <div className="modal-body">
                        <div className="py-3">
                            ...
                            <hr/>
                            <p>
                                2012/1– 2016/1: Análise da comunidade bacteriana de animais marinhos recolhidos do Litoral Norte do Rio Grande do Sul
                            </p>
                            <p>
