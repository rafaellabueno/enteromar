...
class IcaroModal extends React.Component {
    state = {};
    toggleModal = state => {
        this.setState({
                ...
                >
                    ...
                    <div className="modal-body">
                        <div className="py-3">
                            ...
                            <hr/>
                            <p>
                                2019/1– 2019/2: Uma plataforma para caracterização genômica de bactérias do gênero <i> Enterococcus </i> spp.
                            </p>
                            <p>
                    ...
                    <div className="modal-body">
                        <div className="py-3">
                            ...
                            <hr/>
                            <p>
                                2018/2 – 2019/2: Uma plataforma para caracterização genômica de cepas de <i> Enterococcus </i> spp.
